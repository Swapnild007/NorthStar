const NORTHSTAR_CURRICULUM = [
  {
    id:"security-foundations", code:"01", title:"Security Foundations", category:"Foundation",
    description:"Networking, Linux, identity, threat modeling and core security concepts.",
    lessons:[
      {id:"sf-01",title:"Security Mental Models",objective:"Understand assets, threats, vulnerabilities, controls and risk.",read:"Security work starts with a consistent vocabulary. An asset has value, a threat can cause harm, a vulnerability creates an exploitable weakness, and a control reduces likelihood or impact.",practice:"Take a fictional customer portal and identify two assets, two threats, two vulnerabilities and two controls.",check:{q:"Which statement best describes a vulnerability?",options:["A weakness that can be exploited","A business asset","A security team","A completed control"],answer:"A weakness that can be exploited"}},
      {id:"sf-02",title:"CIA Triad & Security Objectives",objective:"Apply confidentiality, integrity and availability to real scenarios.",read:"Confidentiality limits unauthorized disclosure, integrity protects against unauthorized alteration, and availability keeps systems and services usable when needed.",practice:"Classify three incidents by the primary CIA property affected.",check:{q:"A database record is modified without authorization. Which property is directly affected?",options:["Confidentiality","Integrity","Availability","Latency"],answer:"Integrity"}},
      {id:"sf-03",title:"Identity & Access Fundamentals",objective:"Distinguish authentication, authorization, accounting and least privilege.",read:"Authentication establishes who or what an identity is. Authorization determines what that identity may do. Accounting records activity for auditability.",practice:"Design a least-privilege role for a support analyst.",check:{q:"What does authorization answer?",options:["Who are you?","What are you allowed to do?","When did the system start?","How fast is the network?"],answer:"What are you allowed to do?"}},
      {id:"sf-04",title:"Threat Modeling Basics",objective:"Translate system components into abuse cases and security controls.",read:"Threat modeling makes security assumptions explicit. Map trust boundaries, entry points, valuable assets and plausible abuse cases before selecting mitigations.",practice:"Draw a simple trust boundary for a browser, API and database.",check:{q:"What should be identified early in a threat model?",options:["Trust boundaries","Office seating","Logo colors","Printer models"],answer:"Trust boundaries"}},
      {id:"sf-05",title:"Security Operations Vocabulary",objective:"Understand events, alerts, incidents, findings and evidence.",read:"An event is an observed occurrence. An alert is a signal that deserves attention. An incident is a confirmed or suspected security event requiring response.",practice:"Convert a noisy authentication event into a concise analyst finding.",check:{q:"What is evidence used for?",options:["Supporting an investigation or conclusion","Replacing all logs","Increasing CPU speed","Changing a password automatically"],answer:"Supporting an investigation or conclusion"}}
    ]
  },
  {
    id:"network-security", code:"02", title:"Network Security", category:"Network",
  ...
  {
    id:"systems-cloud", code:"03", title:"Systems & Cloud", category:"Foundation",
    description:"Operating systems, cloud architecture, hardening and secure configuration.",
    lessons:[
      {id:"sc-01",title:"Linux Security Fundamentals",objective:"Understand users, groups, permissions, processes and services.",read:"Linux security relies heavily on identity, file permissions, process isolation, service configuration and audit trails. Least privilege applies to both humans and workloads.",practice:"Explain the difference between a user, group and process.",check:{q:"What do file permissions primarily control?",options:["Who may read, write or execute","Which DNS server is used","The CPU clock speed","The screen resolution"],answer:"Who may read, write or execute"}},
  ...
  {
    id:"defensive-security", code:"04", title:"Defensive Security", category:"Defensive",
  ...
  {
    id:"offensive-security", code:"05", title:"Offensive Security", category:"Offensive",
  ...
  {
    id:"security-engineering", code:"06", title:"Security Engineering", category:"Foundation",
